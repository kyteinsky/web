...
title: |
  Add Authentication to your ReactJS / NextJS Single Page Application (SPA)
...
seo:
  ...
  description: |
    Add open source login to any ReactJS / NextJS app using free open source.
  keywords: |
